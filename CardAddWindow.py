...
#         cursor = self.active_text_edit.textCursor()
#         # cursor = self.active_text_edit.curs
#
...
#                     self.progress_bar.setValue(optimized_images)
#
#             cursor.movePosition(cursor.MoveOperation.NextCharacter)
#
...
#         if isinstance(image, QImage):
#             optimized_image = self.optimize_image(image)
#             self.active_text_edit.document().addResource(
#                 QTextDocument.ResourceType.ImageResource,
#                 QUrl(image_format.name()),
#                 optimized_image
#             )
...
#             # new_format.setWidth(optimized_image.width())
#             # new_format.setHeight(optimized_image.height())
...
#         if dialog.exec() == QDialog.DialogCode.Accepted:
#             new_format = QTextImageFormat()
#             new_format.setWidth(dialog.width_spin.value())
#             new_format.setHeight(dialog.height_spin.value())
#             new_format.setName(image_format.name())
...
#             return
#         self.db.add_card(self.pushButton.text(), self.frontTE.toHtml(), self.backTE.toHtml())
#
#     def rejected(self):
#         self.cancelled = True
#         self.reject()
